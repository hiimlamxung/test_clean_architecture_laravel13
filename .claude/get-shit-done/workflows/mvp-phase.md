...
<required_reading>
@D:/SourceCode/Laravel_Test/Test_laravel13_1/.claude/get-shit-done/references/user-story-template.md
@D:/SourceCode/Laravel_Test/Test_laravel13_1/.claude/get-shit-done/references/spidr-splitting.md
@D:/SourceCode/Laravel_Test/Test_laravel13_1/.claude/get-shit-done/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@D:/SourceCode/Laravel_Test/Test_laravel13_1/.claude/get-shit-done/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@D:/SourceCode/Laravel_Test/Test_laravel13_1/.claude/get-shit-done/references/user-story-template.md`:
...
Run the SPIDR rules from `@D:/SourceCode/Laravel_Test/Test_laravel13_1/.claude/get-shit-done/references/spidr-splitting.md`. Briefly:
