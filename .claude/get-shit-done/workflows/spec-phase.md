...
```bash
INIT=$(node "D:/SourceCode/Laravel_Test/Test_laravel13_1/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @D:/SourceCode/Laravel_Test/Test_laravel13_1/.claude/get-shit-done/templates/spec.md.
