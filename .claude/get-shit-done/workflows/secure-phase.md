...
```
Agent(
  prompt="Read D:/SourceCode/Laravel_Test/Test_laravel13_1/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/SourceCode/Laravel_Test/Test_laravel13_1/.claude/get-shit-done/templates/SECURITY.md`
