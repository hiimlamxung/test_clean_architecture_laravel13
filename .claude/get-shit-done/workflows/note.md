...
- **Global scope**: `D:/SourceCode/Laravel_Test/Test_laravel13_1/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `D:/SourceCode/Laravel_Test/Test_laravel13_1/.claude/notes/`)
...
2. Glob `D:/SourceCode/Laravel_Test/Test_laravel13_1/.claude/notes/*.md` (if directory exists) — global notes
...
Global (D:/SourceCode/Laravel_Test/Test_laravel13_1/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `D:/SourceCode/Laravel_Test/Test_laravel13_1/.claude/notes/` — works in any directory
