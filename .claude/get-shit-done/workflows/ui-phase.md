...
```markdown
Read D:/SourceCode/Laravel_Test/Test_laravel13_1/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/SourceCode/Laravel_Test/Test_laravel13_1/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/SourceCode/Laravel_Test/Test_laravel13_1/.claude/agents/gsd-ui-checker.md for instructions.
