...
INSTALL_JS_GLOBAL="D:/SourceCode/Laravel_Test/Test_laravel13_1/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node D:/SourceCode/Laravel_Test/Test_laravel13_1/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
