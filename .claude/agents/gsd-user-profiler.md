...
<reference>
@D:/SourceCode/Laravel_Test/Test_laravel13_1/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `D:/SourceCode/Laravel_Test/Test_laravel13_1/.claude/get-shit-done/references/user-profiling.md` to load:
