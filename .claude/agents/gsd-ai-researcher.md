...
<required_reading>
Read `D:/SourceCode/Laravel_Test/Test_laravel13_1/.claude/get-shit-done/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
